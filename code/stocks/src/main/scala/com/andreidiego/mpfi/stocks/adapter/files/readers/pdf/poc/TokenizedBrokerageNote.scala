...
import com.andreidiego.mpfi.stocks.adapter.files.extractionguide.poc
import poc.FieldName
...
object TokenizedBrokerageNote:
  ...
  import poc.{ExtractionGuide, FixedTokenCoordinate, RegularInstruction, RelativeTokenCoordinate, RepetitionBlock}
