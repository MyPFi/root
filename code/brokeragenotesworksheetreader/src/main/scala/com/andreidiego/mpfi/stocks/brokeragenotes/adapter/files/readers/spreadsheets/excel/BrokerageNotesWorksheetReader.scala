...
import OperationalMode.{DayTrade, Normal}
import stocks.tradingfeesrate.domain.TradingPeriod
import TradingPeriod.{PRE_OPENING, TRADING}
...
object BrokerageNotesWorksheetReader:
  ...
  import com.andreidiego.mpfi.stocks
  import stocks.averagestockprice.domain.AverageStockPriceService
  import stocks.incometaxatsourcerate.domain.IncomeTaxAtSourceRateService
  import stocks.servicetaxrate.domain.ServiceTaxRateService
  import stocks.settlementfeerate.domain.SettlementFeeRateService
  import stocks.tradingfeesrate.domain.TradingFeesRateService
