...
class InvestmentsTest extends FixtureAnyFreeSpec, BeforeAndAfterAll:
  ...
  import stocks.averagestockprice.domain.ProvisionalAverageStockPriceService
  import stocks.incometaxatsourcerate.domain.ProvisionalIncomeTaxAtSourceRateService
  import stocks.servicetaxrate.domain.ProvisionalServiceTaxRateService
  import stocks.settlementfeerate.domain.ProvisionalSettlementFeeRateService
  import stocks.tradingfeesrate.domain.ProvisionalTradingFeesRateService
