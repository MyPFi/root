package com.andreidiego.mpfi.stocks.brokeragenotes.adapter.files.readers.spreadsheets
...
class BrokerageNotesWorksheetReaderTest extends FixtureAnyFreeSpec, BeforeAndAfterAll:
  ...
  import stocks.averagestockprice.domain.testkit.DummyAverageStockPriceService
  import stocks.incometaxatsourcerate.domain.textkit.DummyIncomeTaxAtSourceRateService
  import stocks.servicetaxrate.domain.testkit.DummyServiceTaxRateService
  import stocks.settlementfeerate.domain.testkit.DummySettlementFeeRateService
  import stocks.tradingfeesrate.domain.testkit.DummyTradingFeesRateService
  import stocks.tradingfeesrate.domain.TradingPeriod.PRE_OPENING
