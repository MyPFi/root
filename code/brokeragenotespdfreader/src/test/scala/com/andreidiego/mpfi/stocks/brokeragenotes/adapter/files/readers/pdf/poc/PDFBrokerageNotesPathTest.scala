...
import com.andreidiego.filesystem
import filesystem.FileSystemPath
import filesystem.FileSystemTest.StateFileSystem

@experimental class PDFBrokerageNotesPathTest extends FixtureAnyFreeSpec, ConfigMapFixture:
  import language.deprecated.symbolLiterals
  import filesystem.FileSystem
  import filesystem.FileSystemMessages.resourceNotFound
    ...
    "provide a set of 'Sorter' implementations that would allow the 'content' of a 'FileSystemPath' representing a folder to be ordered by their" - {
      ...
      "or, their filename components, namely:" - {
        ...
        "NoteNumber," in { configMap =>
          val folder = "brokerageNotesFolder/"
          val brokerageNote1 = "broker2/vendaVALE3 - 213 - 08-03-2022.pdf"
          val brokerageNote2 = "broker2/vendaVALE3 - 2130 - 08-03-2022.pdf"
          val brokerageNote3 = "broker3/compraVALE3 - 21306 - 08-03-2022.pdf"
          val brokerageNote4 = "broker1/vendaVALE3 - 21306 - 08-03-2022.pdf"
          val brokerageNote5 = "broker2/vendaVALE3 - 21307 - 08-03-2022.pdf"
          val brokerageNotes = Seq(
            brokerageNote5,
            brokerageNote3,
            brokerageNote4,
          ...
          assertForExisting(folder, brokerageNotes) { (fullPath, fss) ⇒
            PDFBrokerageNotesPath.from[StateFileSystem](fullPath)
              ...
              s"${Path.of(s"$fullPath/$brokerageNote2")}",
              s"${Path.of(s"$fullPath/$brokerageNote3")}",
              s"${Path.of(s"$fullPath/$brokerageNote4")}",
              s"${Path.of(s"$fullPath/$brokerageNote5")}"
            )
          }(configMap.getRequired("targetDir"))
        }
        "or, TradingDate." in { configMap =>
          val folder = "brokerageNotesFolder/"
          val brokerageNote1 = "broker1/vendaVALE3 - 21306 - 08-01-2020.pdf"
          val brokerageNote2 = "broker3/compraVALE3 - 21306 - 07-02-2021.pdf"
          val brokerageNote3 = "broker3/compraVALE3 - 21306 - 07-02-2022.pdf"
          val brokerageNote4 = "broker3/compraVALE3 - 21306 - 07-03-2022.pdf"
          val brokerageNote5 = "broker1/vendaVALE3 - 21306 - 08-03-2022.pdf"
          val brokerageNote6 = "broker2/vendaVALE3 - 21307 - 09-03-2022.pdf"
          val brokerageNote7 = "broker3/compraVALE3 - 21306 - 07-02-2024.pdf"
          val brokerageNotes = Seq(
            brokerageNote7,
            brokerageNote3,
            brokerageNote1,
          ...
          assertForExisting(folder, brokerageNotes) { (fullPath, fss) ⇒
            PDFBrokerageNotesPath.from[StateFileSystem](fullPath)
              ...
              s"${Path.of(s"$fullPath/$brokerageNote4")}",
              s"${Path.of(s"$fullPath/$brokerageNote5")}",
              s"${Path.of(s"$fullPath/$brokerageNote6")}",
              s"${Path.of(s"$fullPath/$brokerageNote7")}"
            )
          }(configMap.getRequired("targetDir"))
        }
      }
...
object PDFBrokerageNotesPathTest:
  ...
  import filesystem.FileSystemTest
