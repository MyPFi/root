...
@experimental object BrokerageNotesPDFReader:
  ...
  import com.andreidiego.filesystem.FileSystemPath.InteractsWithTheFileSystemAndReturns
  import com.andreidiego.extractionguide.{ExtractionGuide, ExtractionGuideSpecPath, ExtractionGuideSpecsPath}
  import ExtractionGuide.ExtractionGuideError.{ParsingError, FileCannotBeOpened}
