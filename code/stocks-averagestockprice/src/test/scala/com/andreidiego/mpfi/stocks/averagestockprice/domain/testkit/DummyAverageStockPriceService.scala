package com.andreidiego.mpfi.stocks.averagestockprice.domain.testkit

import java.time.LocalDate
import java.time.format.DateTimeFormatter
import com.andreidiego.mpfi.stocks.averagestockprice.domain.AverageStockPriceService
